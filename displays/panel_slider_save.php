...
<div id="submitpost" class="submitbox">
	<div id="minor-publishing">
		...
		<div id="misc-publishing-actions">
			<div class="misc-pub-section">
				<label for="section_title" title="<?php _e('Choose a name for this slider.');?>"><strong><?php _e('Slider name:');?></strong></label>
				...
				<input type="checkbox" name="section_display" id="section_display" value="1" <?php if($options['section_display']): ?> checked="checked"<?php endif;?> class="FA_optional"<?php if($fields['section_display'] == 0):?> disabled="disabled"<?php endif;?> /> <label class="FA_optional<?php if($fields['section_display'] == 0):?> disabled<?php endif;?>" for="section_display" title="<?php _e('Choose whether to display the slider title or not');?>"><?php _e('Display slider name');?> </label><br />
			</div>
			
			<div class="misc-pub-section last">
				<strong>Slider size</strong><br>
				<label for="slider_width"><?php _e('Width:');?> </label> <input type="text" name="slider_width" id="slider_width" value="<?php echo $options['slider_width']; ?>" class="small-text" /><br />
				<label for="slider_height"><?php _e('Height:');?> </label> <input type="text" name="slider_height" id="slider_height" value="<?php echo $options['slider_height']; ?>" class="small-text" /><br />
				<span class="note">Note: to disable size control, enter 0 for size.</span>
			</div>					
		</div>
		<div class="clear"></div>
	</div>
	<div id="major-publishing-actions">
        ...
        <div id="delete-action">
        	<a href="<?php echo wp_nonce_url( $current_page.'&noheader=true&action=delete&item_id='.$slider_id );?>" class="submitdelete deletion" onclick="return confirm('Are you sure you want to delete this slideshow?');">Delete</a>
        </div>
        <?php endif;?>
